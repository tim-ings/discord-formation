  ...
  async guildId => {
    ...
    return {
      ...
      systemMessages: {
        ...
        sendBoostMessages: !guild.systemChannelFlags.has(`SUPPRESS_PREMIUM_SUBSCRIPTIONS`),
        sendRandomWelcomeMessages: !guild.systemChannelFlags.has(`SUPPRESS_JOIN_NOTIFICATIONS`),
      },
